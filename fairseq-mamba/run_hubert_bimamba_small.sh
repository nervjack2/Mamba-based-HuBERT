#### Hubert-BiMamba-small Training - Iter 1 #####
...
#     --config-name hubert_bimamba_small_iter1.yaml

##### Hubert-BiMamba-small Training - Iter 2 - Init #####
# python fairseq/fairseq_cli/hydra_train.py                                                               \
#     task.data=/work/hckuo145/MambaSpeechSSL/dataset/LibriSpeech/manifest                                \
#     task.label_dir=/work/hckuo145/MambaSpeechSSL/dataset/LibriSpeech/feature/hubert_bimamba_small_iter1 \
#     task.labels='["km"]'                                                                                \
#     model.label_rate=50                                                                                 \
...
#     --config-dir /work/hckuo145/MambaSpeechSSL/fairseq-mamba/fairseq/examples/hubert/config/pretrain    \
#     --config-name hubert_bimamba_small_iter2.yaml

##### Hubert-BiMamba-small Training - Iter 2 #####
python fairseq/fairseq_cli/hydra_train.py                                                                                                 \
    --config-dir /work/hckuo145/MambaSpeechSSL/fairseq-mamba/fairseq/examples/hubert/config/pretrain                                      \
    --config-name hubert_bimamba_small_iter2.yaml                                                                                         \
    task.data=/work/hckuo145/MambaSpeechSSL/dataset/LibriSpeech/manifest                                                                  \
    ...
    +optimization.update_freq='[4]'                                                                                                       \
    checkpoint.restore_file=/work/hckuo145/MambaSpeechSSL/fairseq-mamba/outputs/hubert_bimamba_small_iter2/checkpoints/checkpoint_init.pt \
