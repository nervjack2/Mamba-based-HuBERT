...
class UpstreamExpert(UpstreamBase):
    ...
    def set_require_grad(self, finetune_step, global_step):
    ...
    def forward(self, wavs):
        ...
        features, feat_padding_mask, conv_features, layer_results = self.model.extract_features(
            padded_wav,
            padding_mask=wav_padding_mask,
            mask=None,
        )
        diff_feature = [f[3].transpose(0, 1) for f in layer_results]
        hidden_states = [conv_features] + diff_feature
        return {
