...
def diff_hubert_local(*args, **kwargs):
    return diff_hubert_custom(*args, **kwargs)


def diff_hubert_url(*args, **kwargs):
    return diff_hubert_custom(*args, **kwargs)
...
def hubert(refresh=False, *args, **kwargs):
    ...
    """
    return diff_hubert_base(refresh=refresh, *args, **kwargs)


def diff_hubert_base(refresh=False, legacy=False, **kwargs):
    """
    The Base model
        refresh (bool): whether to download ckpt/config again if existed
    """
    ...
    return diff_hubert_custom(refresh=refresh, legacy=legacy, **kwargs)


def diff_hubert_large_ll60k(refresh=False, legacy=False, **kwargs):
    """
    The Large model
        refresh (bool): whether to download ckpt/config again if existed
    """
...
def diff_hubert_base_robust_mgr(refresh=False, legacy=False, **kwargs):
    """
