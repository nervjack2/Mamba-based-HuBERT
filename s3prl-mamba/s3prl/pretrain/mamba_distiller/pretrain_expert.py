...
from pretrain.mamba_distiller.dataset import OnlineWaveDataset
from upstream.mamba_distiller.model import DistillerConfig, DistillerModel
    ...
    def __init__(
        ...
        print(
            ...
            + str(sum(
                ...
                if p.requires_grad and not name.startswith('distiller.output_layer')
            ))
        )
